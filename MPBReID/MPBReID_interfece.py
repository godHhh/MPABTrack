...
from MPBReID.reid.modeling.meta_arch import build_model
from MPBReID.reid.utils.checkpoint import Checkpointer
from MPBReID.reid.engine import DefaultTrainer, default_argument_parser, default_setup, launch
...
class MPBReIDInterface:
    ...
    def inference(self, image, detections,img_file_name):
