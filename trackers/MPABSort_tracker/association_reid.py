...
def associate(detections, trackers, iou_threshold, velocities, previous_obs, vdc_weight, iou_type=None, args=None,
    ...
    if with_longterm_reid_correction:
        for m in matched_indices:
            if (iou_matrix[m[0], m[1]] < iou_threshold) and (emb_cost[m[0], m[1]] > longterm_reid_correction_thresh):
