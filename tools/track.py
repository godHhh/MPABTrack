...
from yolox.evaluators import MOTEvaluatorMice as MOTEvaluator
...
def main(exp, args, num_gpu):
    ...
    if not args.with_reid:
        *_, summary = evaluator.evaluate_mice(
                model, is_distributed, args.fp16, trt_file, decoder, exp.test_size, results_folder
        )
    else:
        *_, summary = evaluator.evaluate_mice_reid(
    ...
    gtfiles = glob.glob(os.path.join('../datasets/mice/train', '*/gt/gt_head+tail+body_val_half.txt'))
