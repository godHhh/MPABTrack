...
class Exp(MyExp):
    def __init__(self):
        ...
        self.ckpt = "../pretrained/bee24.pth.tar"
        ...
        self.MPBReID_config = "../MPBReID/configs/bee/sbs_S50.yml"
        self.MPBReID_weights = "../pretrained/bee24_AGW.pth"
        self.with_longterm_reid_correction = True
        self.longterm_reid_correction_thresh = 0.5
        self.longterm_reid_correction_thresh_low = 0.5
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False, run_tracking=True):   # [hgx0411] dataloader related
        ...
        valdataset = MOTDataset(
            data_dir=os.path.join(get_yolox_datadir(), "BEE24"),
