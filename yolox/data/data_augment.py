...
class TrainTransform:
    ...
    def __call__(self, image, targets, input_dim):
        ...
        if len(boxes) == 0:
            ...
            image, r_o, _ = preproc(image, input_dim, self.means, self.std)
        ...
        if len(boxes_t) == 0:
            image_t, r_o, _ = preproc(image_o, input_dim, self.means, self.std)
            boxes_o *= r_o
            boxes_t = boxes_o
            labels_t = labels_o
            ids_t = ids_o
...
class ValTransform:
    ...
    def __call__(self, img, res, input_size):
        ...
        return img, np.zeros((1, 5)), raw_image
